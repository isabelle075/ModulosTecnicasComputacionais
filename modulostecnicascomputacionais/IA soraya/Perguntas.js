export const perguntas = [
        ...
        alternativas: [
            {
                texto: "sim",
                afirmacao: [
                    "Porque dependendo do caso de emergência é atendido rapidamente.",
                    "As ambulancias chegam rapidas em caso de emergencia"
                ],
                proxima: 1,
            },
            {
                texto: "nao",
                afirmacao: [
                    "Pois é uma estrutura pequena para tantos habitantes",
                    "Deveria ter uma unidade maior para melhor atende-los"
                ],
                proxima: 2,
            },
        ]
    },
    {
        ...
        alternativas: [
            {
                texto: "Católica é tranquila",
                afirmacao: [
                    "A festa junina pertence a igreja católica.",
                    "A Festa Junina tornou-se uma oportunidade de unir a fé católica com a alegria das danças",
                    "Essa conexão com a figura de São João trouxe um sentido cristão à celebração, que ganhou um novo significado."
                ],
                proxima: 3,
            },
            {
                ...
                afirmacao: [
                    "porque a cerimônia homenageia santos católicos (São João, Santo Antônio e São Pedro), que não são cultuados por famílias evangélicas",
                    "Alguns adaptam o festejo com outros nomes como festa da colheita e festa da tradição para atribuir outro significado.",
                    "bem como organização de festas juninas por parte dos cristãos aponta efetivamente para a “mundanização” da Igreja"
                ],
                proxima: 4,
            },
        ]
